 ...
 *
 * Auth is a thin layer over Laravel Fortify: it wires Fortify's actions, views
 * and rate limiters. It owns no aggregate of its own — it operates on the User
 * aggregate exposed by the User module. Registered in bootstrap/providers.php.
 */
class AuthServiceProvider extends ServiceProvider
{
    ...
    {
        Fortify::loginView(fn () => redirect()->route('employee.login'));
