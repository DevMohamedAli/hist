    ...
    timeout = setTimeout(() => {
        router.get(
            '/employee/activity-logs',
            {
                ...
                causer_id:
                    selectedCauser.value === 'all' ? '' : selectedCauser.value,
        ...
        >
            <div class="p-5">
                ...
                >
                    ...
                    <div class="space-y-1.5">
                        ...
                        <div class="relative">
                            ...
                            <Input
                                v-model="search"
                                placeholder="الحدث، الوصف، المستخدم..."
                    ...
                    <div class="space-y-1.5">
                        ...
                        <Select v-model="selectedEvent">
                            <SelectTrigger
                                class="transition-all focus:ring-2 focus:ring-orange-500"
                            >
                ...
                >
                    ...
                    <Badge
                        v-if="selectedEvent && selectedEvent !== 'all'"
                        variant="outline"
                        class="gap-1 bg-gray-100 dark:bg-gray-700"
                    >
                        الحدث: {{ selectedEvent }}
                    ...
                    <Badge
                        v-if="selectedCauser && selectedCauser !== 'all'"
                        variant="outline"
                        class="gap-1 bg-gray-100 dark:bg-gray-700"
                    >
                        المستخدم:
                        {{
                            causers.find(
                                (c) => c.id.toString() === selectedCauser,
                            )?.name
                        }}
                        <X
                            @click="selectedCauser = 'all'"
                            class="h-3 w-3 cursor-pointer"
                        />
                    </Badge>
                    <Badge
