                    ...
                    >
                        <div class="flex items-start gap-3">
                            ...
                            <div>
                                ...
                                >
                                    أدخل البيانات الأساسية للطالب واربطه بالتخصص
                                    المناسب. سيصدر النظام رقم القيد تلقائياً حسب
                                    تاريخ الانتساب وإعدادات المعهد.
                                </p>
                            </div>
                        </div>
                    ...
                    >
                        ...
                        <div class="grid gap-5 p-4 md:grid-cols-2">
                            ...
                            <div class="md:col-span-2">
                                ...
                                <div
                                    class="mt-3 grid gap-3 rounded-md border border-blue-100 bg-blue-50/40 p-3 md:grid-cols-[220px_minmax(0,1fr)]"
                                >
                                    <select
                                    ...
                                    <div
                                        v-else-if="
                                            form.qualification_mode === 'new'
                                        "
                                        class="grid gap-3 md:grid-cols-2"
                                    >
                                        <input
                                            v-model="
                                                form.new_qualification_degree_name
                                            "
                                            type="text"
                                        ...
                                        <input
                                            v-model="
                                                form.new_qualification_institution
                                            "
                                            type="text"
                                            class="w-full rounded-md border border-gray-300 px-3 py-2.5 text-gray-950 shadow-sm focus:border-blue-700 focus:ring-2 focus:ring-blue-700/15 focus:outline-none"
                                    ...
                                    <p
                                        v-else
                                        class="rounded-md border border-gray-200 bg-white px-3 py-2.5 text-sm font-bold text-gray-500"
                                    >
                                        يمكن ترك المؤهل فارغاً أثناء التسجيل
                                        الأولي.
                                    </p>
                                </div>
                                ...
                                <p
                                    v-if="form.qualification_mode === 'new'"
                                    class="mt-2 text-xs leading-5 text-gray-500"
                                >
                                    إذا كان المؤهل موجوداً بنفس الاسم والمؤسسة
                                    فلن يتم إنشاء نسخة مكررة.
                                </p>
                            </div>
                        </div>
                    </div>
                    ...
                    >
                        <div class="border-b border-gray-100 p-4">
                            ...
                            <p class="mt-2 text-sm leading-6 text-gray-500">
                                اربط الطالب بمستخدم موجود أو أنشئ له حساب دخول
                                جديد من نفس النموذج.
                            </p>
                        </div>
                ...
                <aside class="space-y-4">
                    ...
                    >
                        ...
                        <p class="mt-2 text-sm leading-7 text-blue-900">
                            عند الحفظ سيولد النظام رقم القيد من كود الإدارة، كود
                            المعهد، سنة القبول، فصل القبول، وتسلسل الطالب.
                        </p>
                    </div>
