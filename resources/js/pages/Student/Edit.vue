...
const form = useForm({
    ...
    qualification_id: props.student.qualification_id
        ? String(props.student.qualification_id)
        : '',
    current_specialization_id: props.student.current_specialization_id
        ? String(props.student.current_specialization_id)
        : '',
        ...
        <div class="mx-auto max-w-7xl space-y-6">
                    ...
                    >
                        <div class="flex items-start gap-3">
                            ...
                            <div>
                                ...
                                >
                                    حدّث بيانات الطالب الأكاديمية والشخصية. رقم
                                    القيد والرقم الوطني وتاريخ الانتساب محفوظة
                                    كسجل تعريفي ولا تعدل من هذه الشاشة.
                                </p>
                            </div>
                        </div>
            ...
            <section class="grid gap-4 md:grid-cols-2 xl:grid-cols-4">
                ...
                >
                    <div class="flex items-center gap-3">
                        ...
                        <div class="min-w-0">
                            ...
                            <p
                                class="truncate text-lg font-extrabold text-gray-950"
                            >
                ...
                >
                    <div class="flex items-center gap-3">
                        <div
                            class="rounded-md bg-orange-50 p-2 text-orange-600"
                        >
                ...
                >
                    <div class="flex items-center gap-3">
                        <div
                            class="rounded-md bg-purple-50 p-2 text-purple-700"
                        >
                    ...
                    >
                        ...
                        <div class="grid gap-5 p-4 md:grid-cols-2">
                            <div class="md:col-span-2">
                                ...
                                <p
                                    v-if="form.errors.current_specialization_id"
                                    class="mt-2 text-sm font-bold text-red-600"
                                >
                            ...
                            <div>
                                <label
                                    class="block text-sm font-bold text-gray-700"
                                    >مستوى الفصل الدراسي</label
                                >
                                <div
                                    class="mt-2 rounded-md border border-blue-100 bg-blue-50 px-3 py-2.5 text-blue-950"
                                >
                                    <p class="text-lg font-extrabold">
                                        الفصل {{ calculatedSemesterLevel }}
                                    </p>
                                    <p
                                        class="mt-1 text-xs leading-5 text-blue-800"
                                    >
                                        يتم احتساب المستوى تلقائياً من سجل
                                        المقررات الناجحة، ولا يتم تعديله يدوياً.
                                    </p>
                                </div>
                            </div>
                            ...
                            <div class="md:col-span-2">
                                ...
                                >
                                    ...
                                    >
                                        {{
                                            qualification.label ??
                                            `${qualification.degree_name} - ${qualification.institution}`
                                        }}
                                    </option>
                                </select>
                                <p
                                    v-if="form.errors.qualification_id"
                                    class="mt-2 text-sm font-bold text-red-600"
                                >
                                ...
                                >
                                    يتم تحميل هذه القائمة مباشرة من جدول
                                    المؤهلات.
                                </p>
                            </div>
                        </div>
                ...
                <aside class="space-y-4">
                    ...
                    >
                        ...
                        <p class="mt-3 text-sm leading-7 text-gray-600">
                            تغيير التخصص أو الحالة قد يؤثر على التسجيلات
                            والتقارير الأكاديمية. استخدم النقل أو الإيقاف من
                            صفحة ملف الطالب عندما تحتاج إلى إجراء رسمي موثق.
                        </p>
                    </div>

                    <div
                        class="rounded-lg border border-blue-100 bg-blue-50 p-4 text-sm leading-7 text-blue-950"
                    >
                        <p class="font-extrabold">حقول محفوظة</p>
                        <p class="mt-2">
                            رقم القيد، الرقم الوطني، وتاريخ الانتساب لا تتغير من
                            هذه الشاشة حتى لا تتعارض مع سجل القبول.
                        </p>
                    </div>
