                    ...
                    >
                        <div class="flex items-start gap-3">
                            ...
                            <div>
                                ...
                                >
                                    عدّل بيانات التخصص وربطه بالقسم العلمي وعدد
                                    الفصول المطلوبة للتخرج. تؤثر هذه البيانات في
                                    التسجيل، التقارير، وخطط الدراسة.
                                </p>
                            </div>
                        </div>
            ...
            >
                    ...
                    <div class="grid gap-5 p-4 md:grid-cols-2">
                        ...
                        <div>
                            ...
                            <p class="mt-2 text-xs leading-5 text-gray-500">
                                يستخدم في الجداول والتقارير، ويجب ألا يتكرر مع
                                تخصص آخر.
                            </p>
                        </div>
                        ...
                        <div class="md:col-span-2">
                            ...
                            />
                            <div
                                class="mt-2 flex items-center justify-between gap-3 text-xs text-gray-500"
                            >
                                <p
                ...
                <aside class="space-y-4">
                    ...
                    >
                        ...
                        <p
                            class="mt-3 rounded-md border border-blue-100 bg-blue-50 px-3 py-2 text-sm font-extrabold text-blue-950"
                        >
                            {{ selectedDepartmentName() }}
                        </p>
                        <p class="mt-3 text-sm leading-7 text-gray-600">
                            تأكد من ربط التخصص بالقسم الصحيح حتى تظهر الشعب
                            والمقررات في القوائم الأكاديمية المناسبة.
                        </p>
                    </div>

                    <div
                        class="rounded-lg border border-orange-100 bg-orange-50 p-4"
                    >
                        ...
                        <p class="mt-3 text-sm leading-7 text-orange-900">
                            تعديل عدد الفصول قد يؤثر على أهلية التخرج وخطة
                            انتقال الطلبة بين الفصول. راجع القرار الأكاديمي قبل
                            الحفظ.
                        </p>
                    </div>
