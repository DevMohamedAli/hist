...
const perPage = ref(
    props.filters.per_page ?? String(props.studyGroups.per_page ?? 10),
);
    ...
    <main class="min-h-screen bg-gray-50 p-4 sm:p-6 lg:p-8" dir="rtl">
        <div class="mx-auto max-w-7xl space-y-6">
                ...
                >
                    <div>
                        ...
                        <p class="mt-2 text-sm text-gray-600">
                            إدارة مجموعات الطلاب حسب التخصص والمستوى والفصل مع
                            تقييد الإنشاء على الفصل النشط المفتوح للتسجيل.
                        </p>
                    </div>
                    <div
            ...
            <section class="rounded-lg bg-white p-6 shadow-md">
                <div
                    class="mb-4 flex items-center gap-2 text-sm font-bold text-blue-800"
                >
            ...
            <section class="overflow-hidden rounded-lg bg-white shadow-md">
                ...
                <div
                    class="flex flex-col gap-4 border-t border-gray-200 px-6 py-4 md:flex-row md:items-center md:justify-between"
                >
                    <p class="text-sm text-gray-600">
                        عرض
                        <span class="font-bold text-gray-900">{{
                            props.studyGroups.from ?? 0
                        }}</span>
                        إلى
                        <span class="font-bold text-gray-900">{{
                            props.studyGroups.to ?? 0
                        }}</span>
                        من أصل
                        <span class="font-bold text-gray-900">{{
                            props.studyGroups.total
                    ...
                    <div
                        v-if="
                            props.studyGroups.total > props.studyGroups.per_page
                        "
                    ...
                    >
                        ...
                        <template
                            v-for="link in props.studyGroups.links"
                            :key="link.label"
                        >
                            <Link
                                v-if="link.url"
