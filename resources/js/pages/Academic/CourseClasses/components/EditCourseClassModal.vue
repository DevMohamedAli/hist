        ...
        >
            ...
            >
                ...
                <DialogHeader class="relative z-10 space-y-1 text-right">
                    ...
                    >
                        <Edit3 class="h-5 w-5 animate-pulse text-orange-300" />
                        تعديل الإسناد الحالي
                    </DialogTitle>
                    <DialogDescription class="text-xs text-blue-100"
                        >تحديث وتعديل بيانات إسناد المحاضر للشعبة الدراسية
                    </DialogDescription>
                </DialogHeader>
            </div>
            ...
            >
                <div class="space-y-2">
                    ...
                    <Select v-model="form.study_group_id">
                        <SelectTrigger
                            class="w-full border-gray-200/80 transition-all focus:ring-2 focus:ring-blue-500/20"
                        >
                            <SelectValue placeholder="اختر المجموعة" />
                        </SelectTrigger>
                        <SelectContent dir="rtl">
                            <SelectItem
                                v-for="g in studyGroups"
                                :key="g.id"
                                :value="String(g.id)"
                            >
                                {{ g.group_name }} —
                ...
                >
                    ...
                    <Button
                        ...
                        class="bg-blue-600 px-5 text-white shadow-md transition-all hover:bg-blue-700"
                    >
                        تحديث البيانات
                    </Button>
                </DialogFooter>
