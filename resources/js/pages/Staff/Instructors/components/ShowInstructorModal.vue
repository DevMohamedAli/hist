                    ...
                    <div>
                        ...
                        <div class="mt-1 flex items-center gap-2">
                            <span class="text-xs font-bold text-slate-500">
                                {{
                                    props.instructor.academic_rank ||
                                    'عضو هيئة تدريس'
                                }}
                            </span>
                            <span
                                ...
                                :class="
                                    statusBadge(props.instructor.status).class
                                "
                            >
                ...
                <section class="space-y-3">
                    ...
                    <div
                        v-if="
                            ...
                            props.instructor.qualifications.length
                        "
                    ...
                    <div
                        v-else
                        class="rounded-xl border border-dashed bg-white p-6 text-center text-sm text-slate-400"
                    >
