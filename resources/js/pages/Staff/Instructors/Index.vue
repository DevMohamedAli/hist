    ...
    <main class="min-h-screen bg-gray-50 p-4 sm:p-6 lg:p-8" dir="rtl">
        <div class="mx-auto max-w-7xl space-y-6">
                ...
                >
                    <div>
                        ...
                        <p class="mt-2 text-sm text-blue-100/80">
                            متابعة وتحديث كافة بيانات الكادر الأكاديمي والمؤهلات
                            المرتبطة بهم.
                        </p>
                    </div>
                    <div
                        class="flex items-center gap-3 rounded-lg border border-white/10 bg-white/10 p-4 text-white shadow-inner backdrop-blur-md"
                    >
            ...
            <div class="flex justify-end">
                <button
                    @click="openCreate"
                    class="inline-flex items-center gap-2 rounded-xl bg-orange-500 px-6 py-3 text-sm font-bold text-white shadow-lg transition-all duration-200 hover:-translate-y-0.5 hover:bg-orange-600 active:translate-y-0"
                >
                    <Plus class="h-5 w-5" />
                    إضافة عضو جديد
                </button>
                ...
                <div class="overflow-x-auto">
                    <table class="w-full min-w-250 text-start text-sm">
                        <thead class="bg-blue-900 text-white">
                            <tr>
                                <th class="w-12 px-6 py-4 text-start font-bold">
                                    #
                                </th>
                                <th class="px-6 py-4 text-start font-bold">
                                    الاسم
                                </th>
                                <th class="px-6 py-4 text-start font-bold">
                                    الرقم الوطني
                        ...
                        <tbody class="divide-y divide-gray-100">
                            ...
                            >
                                ...
                                <td
                                    class="px-6 py-4 font-mono text-xs font-semibold text-gray-600"
                                >
                                    {{ instructor.national_id || '—' }}
                                </td>
                                ...
                                <td class="px-6 py-4 text-center">
                                    <span
                                        ...
                                        :class="
                                            statusBadge(instructor.status).class
                                        "
                                    >
                                        {{
                            ...
                            <tr v-if="instructors.length === 0">
                                <td
                                    colspan="8"
                                    class="px-6 py-12 text-center font-medium text-gray-400"
                                >
        ...
        <ShowInstructorModal
            ...
            :open="isShowOpen"
            :instructor="selectedInstructor"
            @close="isShowOpen = false"
            @edit="
                () => {
                    isShowOpen = false;
                    openEdit(selectedInstructor!);
                }
            "
        />
    </main>
