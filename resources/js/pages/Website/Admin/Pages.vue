...
const cannotSubmitPublished = computed(
...
const submit = () => {
    ...
    if (cannotSubmitPublished.value) {
        form.setError(
            'status',
            'لا تملك صلاحية النشر. اختر مسودة أو اطلب صلاحية النشر.',
        );
    ...
    <AuthenticatedLayout>
        <main class="min-h-screen bg-slate-50 p-6" dir="rtl">
            <div class="mx-auto max-w-7xl space-y-6">
                ...
                >
                    <div
                        class="grid gap-6 p-7 lg:grid-cols-[1fr_340px] lg:items-center"
                    >
                        <div>
                            ...
                            <p class="mt-3 max-w-3xl leading-8 text-blue-100">
                                هذه الصفحة مخصصة فقط لتحديث محتوى "عن المعهد"
                                الذي يظهر للزوار في رابط
                                <span dir="ltr" class="font-bold text-white"
                                    >/pages/about</span
                                >.
                            </p>
                        </div>
                        ...
                        <div
                            class="rounded-3xl bg-white/10 p-5 ring-1 ring-white/15"
                        >
                ...
                >
                    <section class="space-y-6">
                        <div class="rounded-3xl bg-white p-6 shadow">
                            <div class="grid gap-4 md:grid-cols-2">
                                ...
                                <label class="grid gap-2">
                                    ...
                                    >
                                        لا تظهر لك صلاحية النشر حالياً؛ يمكنك
                                        الحفظ كمسودة.
                                    </span>
                                </label>
                            </div>
                        ...
                        <div
                            class="overflow-hidden rounded-3xl bg-white shadow"
                        >
                            <div class="border-b border-slate-100 px-6 py-5">
                                ...
                                <p class="mt-1 text-sm text-slate-500">
                                    استخدم الأدوات لتنسيق النص، ثم شاهد النتيجة
                                    كما ستظهر للزوار.
                                </p>
                            </div>

                            <div
                                class="flex flex-wrap gap-2 border-b border-slate-100 bg-slate-50 p-3"
                            >
                                <button
                                    type="button"
                            ...
                            <p
                                ...
                                class="px-6 pb-5 text-sm font-bold text-red-600"
                            >
                                {{ form.errors.content }}
                            </p>
                        </div>
                    ...
                    <aside class="space-y-6">
                        <section
                            class="rounded-3xl border border-dashed border-slate-300 bg-white p-5 shadow"
                        >
                            <input
                                ref="imageInput"
                                type="file"
                            ...
                            />
                            <div
                                class="flex aspect-[16/10] items-center justify-center overflow-hidden rounded-3xl bg-slate-100"
                            >
                                <img
                                    v-if="imagePreview"
                                    :src="imagePreview"
                                ...
                                <div v-else class="text-center text-slate-400">
                                    ...
                                    <p class="mt-3 text-sm font-extrabold">
                                        لم يتم اختيار صورة
                                    </p>
                                </div>
                            </div>
                        ...
                        <div
                            class="sticky top-6 space-y-3 rounded-3xl bg-blue-950 p-5 text-white shadow-xl"
                        >
                            <button
                                ...
                                :disabled="
                                    form.processing || cannotSubmitPublished
                                "
                            >
                                حفظ صفحة عن المعهد
                            </button>
                            ...
                            <p
                                class="text-center text-xs leading-6 text-blue-100"
                            >
