...
const modalConfig = computed<TwoFactorConfigContent>(() => {
    if (props.twoFactorEnabled) {
        return {
            title: 'تم تفعيل التحقق الثنائي',
            description:
                'امسح رمز QR أو أدخل مفتاح الإعداد في تطبيق المصادقة لديك.',
            buttonText: 'إغلاق',
        };
    }
                            ...
                            >
                                ...
                                <template v-else>
                                    ...
                                    <button
                                        ...
                                        class="relative block h-auto border-r border-border px-3 hover:bg-muted"
                                        type="button"
