...
<template>
    ...
    >
        ...
        >
            <p class="text-sm leading-7 font-bold text-orange-950">
                عند التفعيل سيطلب النظام رمزاً مؤقتاً من تطبيق المصادقة عند
                تسجيل الدخول. هذه خطوة صغيرة لكنها ترفع أمان الحساب كثيراً.
            </p>
        ...
        <div v-else class="space-y-5">
            ...
            >
                <p class="text-sm leading-7 font-bold text-emerald-950">
                    التحقق الثنائي مفعّل. سيُطلب رمز أمان من تطبيق المصادقة عند
                    تسجيل الدخول.
                </p>
